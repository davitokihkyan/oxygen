...
const classes = computed(() =>
    props.active
        ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-amber-400 text-left text-base font-medium text-indigo-700 bg-amber-50 focus:outline-none focus:text-amber-600 focus:bg-amber-100 focus:border-amber-600 transition duration-150 ease-in-out'
